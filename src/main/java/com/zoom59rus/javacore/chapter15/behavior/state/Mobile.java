...
import com.zoom59rus.javacore.chapter15.behavior.state.state.Contact;
import com.zoom59rus.javacore.chapter15.behavior.state.state.Lock;
import com.zoom59rus.javacore.chapter15.behavior.state.state.MediaPlayer;
import com.zoom59rus.javacore.chapter15.behavior.state.state.Sender;
